...
{
    private float visibleRadius = 10f;   // Радиуса видимости объектов
    ...
    private Dictionary<float, string> AddItem(Vector3 playerCoodinates, GameObject otherObject, bool isVisible)
    {
        ...
        if (playerCoodinates == otherObject.transform.position || isVisible)
        {
        ...
        {
            objectsInfo.Add(distanceBetweenObjects, "Character");
        }
